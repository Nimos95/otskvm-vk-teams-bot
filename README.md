...
**Индексы:**
- `idx_users_role` — для быстрого поиска по роли
...
**Индексы:**
- `idx_calendar_events_start_time` — для быстрого поиска по времени
- `idx_calendar_events_google_id` — для поиска по Google ID
